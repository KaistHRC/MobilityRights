    ...
    return(
        <div className="ui-container">
            ...
            <div className="facilityExp__">
                ...
                <h2 className="facilityExp__name">건물 주변 보도 경사</h2>
                ...
                <h2 className="facilityExp__name">점자 안내</h2>
